...
from .views import ActiveAppointments,AllProducts,AddProductToAppointment,AllAppointments,remove_product_from_appointment,MakeDoneAppointment,MakePaidAppointment
